...
import {
  ...
  extendViteConfig,
  mergeViteConfig,
} from "@quasar/app-vite/lib/config-tools.js";
import pwaConfig from "@quasar/app-vite/lib/modes/pwa/pwa-config.js";
import quasarVitePluginPwaResources from "@quasar/app-vite/lib/modes/pwa/vite-plugin.pwa-resources.js";
import { plugin: ssgVitePlugin } from "./plugins/vite.ssg.js";
import { viteVersion } from "./helpers/banner-global.js";

export function viteClient(quasarConf) {
...
export function viteServer(quasarConf) {
...
export funtion workbox(quasarConf) {
...
export function customSw(quasarConf) {
